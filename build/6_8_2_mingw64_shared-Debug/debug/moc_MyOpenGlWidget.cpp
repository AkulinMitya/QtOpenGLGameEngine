...
namespace {
struct qt_meta_tag_ZN14MyOpenGLWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN14MyOpenGLWidgetE = QtMocHelpers::stringData(
    "MyOpenGLWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14MyOpenGLWidgetE[] = {
...
Q_CONSTINIT const QMetaObject MyOpenGLWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14MyOpenGLWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14MyOpenGLWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14MyOpenGLWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyOpenGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14MyOpenGLWidgetE.stringdata0))
